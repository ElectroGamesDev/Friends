...
public class ConfigManager {
    ...
    public ConfigManager(@Nonnull Path pluginDataFolder) {
        this(pluginDataFolder, "config.json");
    }

    public ConfigManager(@Nonnull Path pluginDataFolder, @Nonnull String filename) {
        this.configFile = pluginDataFolder.resolve(filename);
